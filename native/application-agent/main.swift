...
let products = [Product(id: "amove", name: "Amove", bundleIdentifier: "com.opense.Amove"), Product(id: "vox", name: "Vox", bundleIdentifier: "com.moirasia.vox"), Product(id: "exithibition", name: "Exithibition", bundleIdentifier: "com.local.Exithibition"), Product(id: "bonded", name: "Bonded", bundleIdentifier: "com.opense.Bonded"), Product(id: "orbis", name: "Orbis", bundleIdentifier: "com.opense.Orbis")]
