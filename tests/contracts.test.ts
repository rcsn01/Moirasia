...
describe('controller contracts', () => {
  it('exposes standalone applications and embedded controller pages', () => {
    expect(APPLICATION_IDS).toEqual(['amove', 'vox', 'bonded', 'shout'])
    ...
    expect(isApplicationId('vox')).toBe(true); expect(isApplicationId('bonded')).toBe(true); expect(isApplicationId('shout')).toBe(true); expect(isApplicationId('orbis')).toBe(false); expect(isApplicationId('module')).toBe(false)
    expect(isControllerPage('general')).toBe(true); expect(isControllerPage('features')).toBe(true); expect(isControllerPage('vox')).toBe(false); expect(isControllerPage('bonded')).toBe(true); expect(isControllerPage('shout')).toBe(true); expect(isControllerPage('orbis')).toBe(false)
