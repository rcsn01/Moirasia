...
describe('controller contracts', () => {
  it('exposes standalone applications and embedded controller pages', () => {
    ...
    expect(isControllerPage('general')).toBe(true); expect(isControllerPage('features')).toBe(true); expect(isControllerPage('vox')).toBe(true); expect(isControllerPage('bonded')).toBe(true); expect(isControllerPage('orbis')).toBe(true)
