...
import type { NativeChangeJournalAddon } from '../packages/feature-orbis/src/main/change-journal'

const addonPath = resolve('apps/Orbis/native', `orbis-metadata.darwin-${process.arch === 'arm64' ? 'arm64' : 'x64'}.node`)
