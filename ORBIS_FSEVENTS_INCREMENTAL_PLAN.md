...
Extend `packages/feature-orbis/native/src/lib.rs` with synchronous, bounded calls intended for the scan worker:
...
- `packages/feature-orbis/src/main/progressive-database.ts`
- `packages/feature-orbis/src/main/progressive-scanner.ts`
- `packages/feature-orbis/src/main/feature.ts`

Add `packages/feature-orbis/src/main/index-manifest.ts` for loading, atomic publication, recovery, permissions, and orphan cleanup.
...
- `packages/feature-orbis/native/src/lib.rs`
- `packages/feature-orbis/native/build.rs`
- `packages/feature-orbis/native/Cargo.toml`
- `packages/feature-orbis/src/main/scan-metadata.ts`
- `packages/feature-orbis/src/main/scan-worker.ts`

Add `packages/feature-orbis/src/main/change-journal.ts` with a small interface that supports a fake journal in tests.
...
- `packages/feature-orbis/src/main/persistent-index-database.ts`
- `packages/feature-orbis/src/main/incremental-scanner.ts`
- `packages/feature-orbis/src/main/refresh-engine.ts`
...
- `docs/architecture/orbis-progressive-scanning.md`
- `README.md`
- `packages/feature-orbis/scripts/benchmark-scan.ts`
