...
const EMPTY: ControllerSnapshot = { applications: featureCatalog.entries.map(({ id, label }) => ({ id, label, bundleId: '', installed: false, running: false })), appearances: { version: 1, revision: 0, values: { moirasia: 'system', amove: 'system', vox: 'system', exithibition: 'dark', bonded: 'system', orbis: 'system', yn360: 'system' } }, features: [] }
