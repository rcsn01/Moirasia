...
export function installApplicationMenu(openApplication: (id: ApplicationId) => void, navigate: (page: ControllerPage) => void, checkForUpdates: () => void): void {
  Menu.setApplicationMenu(Menu.buildFromTemplate([
    { label: 'Moirasia', submenu: [{ role: 'about' }, { label: 'Check for Updates…', click: () => checkForUpdates() }, { type: 'separator' }, { label: 'Settings…', accelerator: 'CommandOrControl+,', click: () => navigate('general') }, { type: 'separator' }, { role: 'quit' }] },
