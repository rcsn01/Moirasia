...
Orbis currently awaits each `lstat` and each directory recursion serially in `packages/feature-orbis/src/main/scanner.ts`. PDU's main advantage is parallel work across independent child subtrees.
