...
public enum MoiraExithibition {
    public static let canvas = color(RGB(12, 10, 9))
    public static let surface = color(RGB(28, 25, 23))
    public static let surfaceRaised = color(RGB(41, 37, 36))
    public static let textPrimary = color(RGB(250, 250, 249))
    public static let textMuted = color(RGB(168, 162, 158))
    public static let border = color(RGB(255, 255, 255, 0.1))
    public static let cool = color(RGB(23, 62, 54))
    public static let warm = color(RGB(85, 230, 165))
    public static let hot = color(RGB(255, 116, 77))
    public static let loadLow = color(RGB(20, 54, 45))
    public static let loadHigh = color(RGB(56, 217, 149))
    public static let focus = color(RGB(126, 246, 194))
    public static let selected = color(RGB(186, 255, 220))
    public static let battery = color(RGB(99, 207, 120))
    public static let storage = color(RGB(81, 168, 232))
    public static let fan = color(RGB(189, 138, 255))
    public static let windowBackground = color(RGB(12, 10, 9))
}
